    ...
    <div className="w-full mt-20 max-w-1xl bg-[#121212] text-gray-200 font-roboto min-h-screen flex flex-col items-center px-4 md:px-6 py-6">
      <div className="flex flex-col space-y-3 max-w-2xl">
        ...
        <div className="text-gray-200 text-sm sm:text-base leading-relaxed">
          <ul className="space-y-2 text-center">
            <li>
              💡 <b>Специалисты ЦИТО:</b> Проверенные методики.
            </li>
            <li>
              🛠 <b>Минимум оборудования:</b> Занятия в офисе.
            </li>
            <li>
              📱 <b>Простота:</b> Формат через Telegram-бот.
            </li>
            <li>
              🏆 <b>Результат:</b> Здоровье и комфорт.
            </li>
          </ul>
        </div>
        <button
